...
public class VideoDecoder implements Disposable{
    ...
    public native VideoDecoderBuffers loadStream (VideoFileReader reader)
		...
		try {
            ...
            jclass cls = env->FindClass("yellow/video/VideoDecoder$VideoDecoderBuffers");
            if(cls == NULL) {
                logError("[wrapped_Java_yellow_videoVideoDecoder_loadFile] Could not find VideoDecoderBuffers class");
                return NULL;
            }
